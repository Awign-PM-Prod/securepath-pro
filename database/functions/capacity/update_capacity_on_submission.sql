-- =====================================================
-- Update Capacity on Case Submission
...
BEGIN
    ...
    IF NEW.status = 'submitted' AND (OLD.status IS NULL OR OLD.status != 'submitted') THEN
        ...
        IF vendor_id IS NOT NULL THEN
            ...
            -- Update vendor capacity tracking (if table exists)
            -- Note: You may need to create a vendor_capacity_tracking table similar to capacity_tracking
            -- For now, we'll just update the vendors table
        END IF;
