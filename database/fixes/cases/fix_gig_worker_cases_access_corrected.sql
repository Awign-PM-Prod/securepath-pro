-- Fix gig worker access to cases and create test data (Corrected version)
-- This script uses the correct case_status enum values

-- First, let's check what case statuses actually exist
DO $$
DECLARE
  case_count integer;
  ...
  IF test_gig_worker_id IS NOT NULL THEN
    ...
    IF case_count = 0 THEN
      ...
      (
        ...
        24,
        NOW() + INTERVAL '2 days',
        'auto_allocated',  -- Using valid enum value
        500.00,
        500.00,
        test_gig_worker_id,
        'gig_worker',
