-- Create password setup tokens table for gig workers (Safe version)
...
DROP POLICY IF EXISTS "Users can view their own setup tokens" ON public.password_setup_tokens;
DROP POLICY IF EXISTS "Admins can manage all setup tokens" ON public.password_setup_tokens;
