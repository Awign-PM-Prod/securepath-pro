-- Fix gig worker access to gig_partners table
-- This script ensures gig workers can access their own data
...
-- Drop existing policies on gig_partners
...
-- Also ensure profiles table has proper policies for gig workers
