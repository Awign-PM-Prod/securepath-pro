...
export default function AllocationActions({ 
  ...
  const canAllocate = ['created', 'auto_allocated', 'pending_acceptance'].includes(currentStatus);
  const canReallocate = ['auto_allocated', 'pending_acceptance'].includes(currentStatus);
