-- =====================================================
-- Add Missing Columns to Cases Table - FIXED VERSION
-- Based on DATABASE_SCHEMA_DESIGN.md analysis
-- =====================================================

-- Step 1: Add missing columns to cases table (nullable first)
DO $$
BEGIN
...
-- Step 5: Add missing columns to client_contracts table
DO $$
BEGIN
...
-- Step 6: Create pincode_tiers table if it doesn't exist
...
-- Step 8: Enable RLS on pincode_tiers table
ALTER TABLE public.pincode_tiers ENABLE ROW LEVEL SECURITY;

-- Step 9: Create RLS policies for pincode_tiers
DO $$
BEGIN
...
-- Step 10: Insert sample data if pincode_tiers is empty
...
-- Step 11: Drop existing functions if they exist (to avoid return type conflicts)
...
-- Step 12: Create the database functions
